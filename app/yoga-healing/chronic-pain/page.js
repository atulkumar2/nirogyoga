    ...
    return (
        <main>
            ...
            <div className={styles.container}>
                ...
                <section id="research" className={styles.reportSection}>
                    <h2 className={styles.reportTitle}>In-Depth Research: Impact of Yoga for Chronic Low Back Pain</h2>

                    <h3 id="introduction" className={styles.reportSubtitle}>Introduction</h3>
                    <p className={styles.text}>
                    ...
                    <h3 id="study-types" className={styles.reportSubtitle}>Types of Studies and Methodological Features</h3>
                    <p className={styles.text}>
                    ...
                    <h3 id="outcomes" className={styles.reportSubtitle}>Main Clinical Outcomes - Pain and Function</h3>
                    <p className={styles.text}>
                    ...
                    <h3 id="duration" className={styles.reportSubtitle}>Duration and Persistence of Benefit</h3>
                    <p className={styles.text}>
                    ...
                    <h3 id="comparative" className={styles.reportSubtitle}>Comparative Effectiveness vs Other Active Treatments</h3>
                    <p className={styles.text}>
                    ...
                    <h3 id="mental-health" className={styles.reportSubtitle}>Mental-Health, Quality of Life, and Biopsychosocial Outcomes</h3>
                    <p className={styles.text}>
                    ...
                    <h3 id="mechanisms" className={styles.reportSubtitle}>Mechanisms of Action</h3>
                    ...
                    <h3 id="safety" className={styles.reportSubtitle}>Safety and Adverse Events</h3>
                    <p className={styles.text}>
                    ...
                    <h3 id="virtual" className={styles.reportSubtitle}>Newer Developments: Virtual Delivery</h3>
                    <p className={styles.text}>
                    ...
                    <h3 id="limitations" className={styles.reportSubtitle}>Limitations of the Current Evidence</h3>
                    ...
                    <h3 id="clinical" className={styles.reportSubtitle}>Clinical Implications and Practical Recommendations</h3>
                    <p className={styles.text}>
                    ...
                    <h3 id="conclusions" className={styles.reportSubtitle}>Conclusions</h3>
                    <p className={styles.text}>
                    ...
                    <h3 id="references" className={styles.reportSubtitle}>Key References (PubMed / PMC sources)</h3>
