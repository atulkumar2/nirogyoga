...
const PAGES_TO_TEST = [
    ...
    '/testimonials',
    '/parvati-kitchen',
    '/parvati-kitchen/multigrain-choco-chip-cookies',
    '/parvati-kitchen/multigrain-cupcakes',
    '/parvati-kitchen/dates-cake-multigrain',
    '/parvati-kitchen/cashew-caramel-icecream',
    '/parvati-kitchen/almond-butter',
    '/parvati-kitchen/tiramisu',
    '/parvati-kitchen/multigrain-jaggery-chocolate-cake',
    '/parvati-kitchen/mango-multigrain-jaggery-cake',
    '/parvati-kitchen/korean-cream-cheese-buns',
    '/knowledge-base',
